...
noremap <expr> ,f expand('<cword>') ==# 'true' ? "ciwfalse\" : (expand('<cword>') ==# 'false' ? "ciwtrue\" : '')
nmap ,( cs((
nmap ,0 :call SetHardTab()
nmap ,4 :call SetSoftTab(4)
nmap ,2 :call SetSoftTab(2)
nmap ,t :TlistToggle
nmap ,l :set list!
nmap < <<
nmap > >>
...
vnoremap <silent> <C-Down> :call MoveVisualDown()
vnoremap <silent> <C-Up> :call MoveVisualUp()
...
silent only
cd /var/www/jasmine-talk
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 index.html
badd +0 css/sequoia.css
badd +0 js/reveal.js
badd +0 css/main.css
args index.html
edit index.html
...
silent! normal! zE
let s:l = 132 - ((0 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
132
normal! 024l
tabedit js/reveal.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 900 - ((24 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
900
normal! 023l
tabedit css/sequoia.css
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 98 - ((23 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
98
